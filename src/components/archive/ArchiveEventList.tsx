...
export default function ArchiveEventList({ events }: Props) {
  if (events.length === 0) {
    return <div className={cn("p-8 text-center", shellPanelFlat, shellTextMuted)}>Brak archiwalnych wydarzeń.</div>;
  }
        ...
        return (
          <li key={event.id}>
            <a
              ...
              className={cn(
                "block w-full rounded-xl border p-4 backdrop-blur-md transition-colors",
