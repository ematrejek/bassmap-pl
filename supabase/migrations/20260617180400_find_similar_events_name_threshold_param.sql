-- S-13: Pass name similarity threshold as RPC parameter (sync with TS constant).

DROP FUNCTION IF EXISTS public.find_similar_event_candidates(text, text, timestamptz, uuid, uuid, boolean);
