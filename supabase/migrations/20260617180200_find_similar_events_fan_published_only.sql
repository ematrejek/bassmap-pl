-- S-13: Fan check-similar excludes pending by default; admin keeps published + pending.
...
GRANT EXECUTE ON FUNCTION public.find_similar_event_candidates(text, text, timestamptz, uuid, uuid, boolean) TO authenticated;
